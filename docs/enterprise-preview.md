...
当前预览 `26.901.51231-enterprise-preview.2` 基于官方 Windows x64 MSIX `26.901.6511.0`，SHA-256 为 `fd9ae9eeeeaf11577191ce5a39d0b8f95fa73d591aa3a94f688b84d294d1fa85`。版本、来源与摘要固定在 `config/enterprise-preview.json`。官方稳定下载地址会滚动更新；若摘要不符，构建立刻失败，必须提供保存的固定版本 MSIX，不能自动接受新包。
...
node scripts/smoke-enterprise-preview.mjs dist/enterprise-current/TEENet-Codex-26.901.51231-enterprise-preview.2 dist/enterprise-current/smoke
```
