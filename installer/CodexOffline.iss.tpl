...
Root: HKCU; Subkey: "Software\Classes\codex\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{sys}\wscript.exe"" ""{app}\Codex.vbs"" ""%1"""; Flags: uninsdeletekey; Tasks: codexlinks
