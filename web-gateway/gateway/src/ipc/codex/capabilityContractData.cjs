...
const DESKTOP_ASAR_PATCH_MARKERS = Object.freeze([
  ...
  "/*codex-offline:codex-only-startup*/",
  "/*codex-offline:codex-only-selector*/",
  "/*codex-offline:codex-only-transition*/",
  "/*codex-offline:local-tasks-only-composer*/",
  "/*codex-offline:cloud-task-schema-disabled*/",
  "/*codex-offline:cloud-task-runtime-blocked*/",
  "/*codex-offline:cloud-task-list-disabled*/",
  "/*codex-offline:cloud-task-detail-disabled*/",
]);
